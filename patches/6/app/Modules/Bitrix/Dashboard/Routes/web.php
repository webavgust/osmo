...
Route::group(['prefix' => 'dashboard', 'middleware' => []], function () {
    ...
    Route::group(['prefix' => 'box'], function() {
        ...
        // продление лицензий (виджет дашборда)
        Route::get('/license_renewal', [\App\Modules\Pub\LicenseKey\Controllers\LicenseKeyBoxController::class, 'renewal'])->name('dashboard.box.license_renewal');
    });
