...
Route::group(['prefix' => 'partners'], function () {
    Route::group([], function () {
        ...
        // вкладка «Сделки Битрикс» на карточке партнёра — грузится ajax'ом (patch v23)
        Route::get('/deals/{partner}', [\App\Modules\Pub\Partner\Controllers\PartnerController::class, 'deals'])->name('partner.deals');
    });
});
