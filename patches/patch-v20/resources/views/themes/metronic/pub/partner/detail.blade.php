...
{{--                            </x-ui.card.card_table_tr>--}}
                ...
                <div class="card mt-5">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <x-ui.badge.light type="secondary">{{ $partner->companies->count() }}</x-ui.badge.light>
                    </div>
                    <div class="card-body p-0">
                                    ...
                                    <div class="tr">
                                        ...
                                        <span class="td">
                                            @if(($spec_counts[$company->id] ?? 0) > 0)
                                                {{ tools()->num_rus($spec_counts[$company->id], ['спецификации', 'спецификация', 'спецификаций'], true) }}
                                            @else
                                                <span class="text-muted">без спецификаций</span>
                                            @endif
                                        </span>
                                    </div>
                                @endforeach
