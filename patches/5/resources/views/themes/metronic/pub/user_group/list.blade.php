                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table table-row-dashed table-row-gray-300 align-middle mb-0 v-middle search-table">
                                <thead class="table-light">
                                <tr class="header-item">
                                    <th class="border-bottom border-top" width="1">ID</th>
                                ...
                                @foreach($groups as $group)
                                    <tr class="search-items">
                                        ...
                                        <td>
                                            <a href="{{ route('user_group.detail', $group) }}">
                                                {{ $group->name }}
                                            </a>
                                        </td>
                                        <td align="center">
