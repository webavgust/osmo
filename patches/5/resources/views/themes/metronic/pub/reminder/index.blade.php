                    ...
                    <div class="card-body">
                        <ul class="timeline timeline-left">
                            <li class="timeline-inverted timeline-item">
                                    <div class="timeline-badge primary" id="remind_add" onclick="javascript:sidebar({href: '{{ route('reminder.sidebar_add') }}', method: 'POST'})">
                                        <x-ui.icon.light icon="fa-plus" class="text-white"></x-ui.icon.light>
                                    </div>
                                <div class="timeline-panel invisible">
                                    <x-ui.button.default btn_type="success" onclick="javascript:sidebar({href: '{{ route('reminder.sidebar_add') }}', method: 'POST'})" >Добавить новое напоминание</x-ui.button.default>
                                </div>
                            </li>
                            @forelse($reminders as $remind)
                                <x-reminder.row :remind="$remind"></x-reminder.row>
                            @empty
                                <x-reminder.row_empty></x-reminder.row_empty>
                            @endforelse
                        </ul>
