...
{{--            @foreach(['scenarios' => 'Сценарии', 'services' => 'Нейросервисы'] as $mode => $caption)--}}
                <div class="col-6">
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle">
                        ...
                        <tr>
                            <th class="p-1 px-2 fs-3 fw-bold" width="1">Место</th>
                            <th class="p-1 px-2 fs-3 fw-bold">Нейросервис</th>
                            <th class="text-nowrap p-1 px-2 fs-3 fw-bold">Кол-во</th>
                            <th class="text-nowrap p-1 px-2 fs-3 fw-bold">Продано</th>
                        </tr>
                        </thead>
                        <tbody>
                            @php
