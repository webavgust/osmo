...
| 11 | v33 | Связка КП «главное / второстепенное» (см. «Итерация 13») | готов 23.09.2026, проверен локально (агентами в транзакциях и мной в браузере; пара ВДНХ связана локально через попап); README `patches/patch-v33/README.md`; не закоммичен, на прод не выкачен |
