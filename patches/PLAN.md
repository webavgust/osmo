...
| 17 | v40 | Воронка продаж без сделок Wei Wei [195] и Александра Суханова [191] — все таблицы, попапы, фильтр, «Сделки с ошибками» и выгрузки таблиц воронки; реестр и рабочий стол не меняются | готов 25.09.2026, не закоммичен; README `patches/patch-v40/README.md` |
