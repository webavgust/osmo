            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <center class="mt-4">
                                ...
                                <h6 class="card-subtitle">
                                    ...
                                    <div class="fs-3 mb-1 badge fw-semibold bg-light-primary text-primary ">{{ $user->work_position }}</div>
                                </h6>
                ...
                <div class="col-lg-4 col-xlg-9 col-md-7">
                    ...
                    <div class="card users">
                        <div class="card-header min-h-auto py-3 bg-light-secondary rounded-top">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            >
                                <div class="card-body">
                                    ...
                                    <h4 class="fw-semibold mt-4">Skill Set</h4>
                                    <hr />
                                    <h5 class="mt-4">
