...
@section('content')
    @php
        try {
            $columns = $proposal_variants->count() + 5;
            $columns_show = $proposal_variants->count();
            $rows = max(30, $columns_show + 5);
    @endphp
    <link
        rel="stylesheet"
        type="text/css"
    ...
    <style>
        ...
        .fast_scenario_add, .fast_work_add, .fast_soft_add, .fast_platform_add {
            display: none !important
        }
        ...
        /*.common_platform_add { display: none; }*/
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form id="form_create" class="init">
                        <input type="hidden" name="parent" value="{{ $proposal->id }}"/>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3">
                                    <label for="tb-fname" class="text-end col-form-label fw-semibold">Название <span
                                            class="text-danger">*</span></label>
                                    <input required name="name" type="text" class="form-control " id="tb-fname"
                                           placeholder="" value="{{ $proposal->name }}">
                                </div>
                                <div class="col-3">
                                    <label for="tb-fname" class="text-end col-form-label fw-semibold">Название
                                        (альт.)</label>
                                    <input name="name_alt" type="text" class="form-control " id="tb-fname"
                                           placeholder="" value="{{ $proposal->name_alt }}">
                                </div>
                                <div class="col-2">
                                    <label for="tb-fname" class="text-end col-form-label fw-semibold">Дата КП <span
                                            class="text-danger">*</span></label>
                                    <input required name="date" type="date" class="form-control w-100" id="tb-fname"
                                           placeholder="" value="{{ $proposal->sended_at->format("Y-m-d") }}"
                                           style="width: 140px">
                                </div>
                                <div class="col-2">
                                    <label for="tb-fname" class="text-end col-form-label fw-semibold">Менеджер <span
                                            class="text-danger">*</span></label>
                                    <x-ui.select.single :items="$users" id="id" value-name="full-name" required
                                                        name="manager"
                                                        :value="$proposal->manager->id"></x-ui.select.single>
                                </div>
                                <div class="col-1 pe-0">
                                    <label for="tb-fname" class="text-end col-form-label fw-semibold">
                                        Номер КП <span class="text-danger">*</span>
                                    </label>
                                    <div class="d-flex align-items-center">
                                        <input required name="number" type="text" class="form-control fs-2 "
                                               id="tb-fname" value="{{ $proposal->number }}"
                                               placeholder="" value="{{ old('date') }}" style="width: 140px">


                                        <a href="javascript:void(0)"
                                           onclick="javascript:$(`select[name='manager']`).change()"
                                           class="ms-2 fw-bold fs-1 text-nowrap">
                                            {{ $max_number }}
                                        </a>
                                    </div>
                                </div>
                                <div class="col-1 pe-0">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <input required name="nds" type="text" class="form-control fs-2 " id="tb-fname" value="{{ $proposal->nds }}"
                            ...
                            <div class="mb-5 row">
                                <div class="col-3">
                                    <label for="tb-fname" class="col-sm-4 col-form-label fw-semibold">Компания <span
                                            class="text-danger">*</span></label>
                                    <x-ui.select.single class="select2" name="company" required :items="$companies"
                                                        id="key" value-name="label"
                                                        :value="$proposal->company?->id ?? 0"></x-ui.select.single>
                                </div>
                                <div class="col-3">
                                    <label for="tb-fname" class="col-sm-4 col-form-label fw-semibold">Партнёр <span
                                            class="text-danger">*</span></label>
                                    <x-ui.select.single class="select2" name="partner" required :items="$partners"
                                                        id="key" value-name="label"
                                ...
                                @if($proposal->isForeignCurrency)
                                    <div class="col-2">
                                        <label for="tb-fname"
                                               class="col-sm-4 col-form-label fw-semibold">Валюта</label>
                                        <div class="fw-bold fs-3 pt-1">
                                            <div>
                                                {{ $proposal->currency->name }}:
                                                <span class="text-nowrap text-danger">1 {{ $proposal->currency->symbol }} = {{ $proposal->currency_rate }} {{ $proposal->proposal_parent?->currency?->symbol ?? '?' }}</span>
                                            </div>
                                            @if($proposal->currency_rate_cumulative !== $proposal->currency_rate)
                                                <div>Для новых нейронок: <span class="text-nowrap text-danger">1 {{ $proposal->currency->symbol }} = {{ $proposal->currency_rate_cumulative }} {{ $cur_symbol }}</span>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="col-3">
                                    <label for="tb-fname" class="col-sm-4 col-form-label fw-semibold">Язык</label>
                                    <div class="d-flex">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="lang" id="lang_ru"
                                                   value="ru" @checked($proposal->lang == 'ru')>
                                        ...
                                        <div class="form-check ms-3">
                                            <input class="form-check-input" type="radio" name="lang" id="lang_en"
                                                   value="en" @checked($proposal->lang == 'en')>
                                ...
                                <div class="col-md-12 position-relative">
                                    <div id="variant_add" class=" position-absolute" style="right: 5px; top: -8px;">
                                        <a href="javascript:column_add();">
                                            <x-ui.icon.solid icon="fa-circle-plus text-success" class="fs-5"/>
                                        </a>
                                    </div>

                                    <div class=" mt-10 table-responsive" style="clear: both">
                                        <table border="1" class="table table-hover table-bordered border-gray-300"
                                               id="table_data"
                                               count="{{ count($scenario_matrix) }}"
                                               work_count="{{ $proposal->works->count() }}"
                                               soft_count="{{ $proposal->software->count() }}"
                                               platform_count="{{ $platforms_have->count() }}"
                                               column="{{ $proposal_variants->count() }}"
                                               style="width: auto; min-width: 100%">

                                            {{-- СЕЛЕКТОР ВАРИАНТОВ --}}
                                            <tr class="variants">
                                                <td colspan="3"
                                                    style=" border-left: 1px solid white; border-top: 1px solid white; border-bottom: 1px solid white;"/>
                                                @for($i = 1; $i <= $columns; $i++)
                                                    @php
                                                        $variant = $proposal->variants[$i - 1] ?? null;
                                                    @endphp
                                                    <th column="{{ $i }}"
                                                        @class(["p-1 px-2 border-start border-bottom flex-grow-0", "d-none" => $i > $columns_show, "column_hl" => $i == 1]) style="width: 200px!important">
                                                        <input type="hidden" name="variant_id[{{ $i }}]"
                                                               value="{{ $variant->id ?? 0}}">
                                                        <div class="d-flex">
                                                            <div
                                                                class="flex-grow-1 d-flex align-items-center period_type_selector">
                                                                {{--                                                            <x-ui.icon.regular icon="fa-ellipsis-stroke-vertical" class="me-2 fs-3 handler"/>--}}

                                                                <div class="input-group">
                                                                    <input type="checkbox"
                                                                           name="period_active[{{ $i }}]"
                                                                           @class(["d-none period_active"]) @checked(!empty($variant)) value="1">
                                                                    <select name="period[{{ $i }}]"
                                                                            class="form-select period p-1 fs-3 flex-grow-1"
                                                                            prev-value="{{ $variant->period_type ?? 'year' }}">
                                                                        <option value="year">Годовая</option>
                                                                        <option
                                                                            @selected(!empty($variant) && $variant->period_type == 'pilot') value="pilot">
                                                                            Пилот
                                                                        </option>
                                                                        <option
                                                                            @selected(!empty($variant) && $variant->period_type == 'unlimited') value="unlimited">
                                                                            Безлимит
                                                                        </option>
                                                                    </select>
                                                                    <input name="period_value[{{ $i }}]" maxlength="2"
                                                                           type="text"
                                                                           class="form-control p-1 fs-3 flex-grow-0 text-center count"
                                                                           style="width: 30px"
                                                                           value="{{ $variant->period_value ?? 1 }}"
                                                                           prev-value="{{ $variant->period_value ?? 1 }}">
                                                                </div>
                                                            </div>
                                                            <div class="pt-1 column_delete">
                                                                <x-ui.icon.regular icon="fa-xmark"
                                                                                   class="text-danger ms-2 cursor-pointer"
                                                                                   onclick="javascript:column_delete($(this))"/>
                                                            </div>
                                                        </div>
                                                    </th>
                                                @endfor
                                            ...
                                            <tr class="main_selector">
                                                ...
                                                @for($i = 1; $i <= $columns; $i++)
                                                    <td column="{{ $i }}"
                                                        @class(["border-start border-bottom flex-grow-0 border-bottom-0 p-0 py-2", "d-none" => $i > $columns_show, "column_hl" => $i == 1])  style="width: 140px!important">
                                                        <div class="d-flex justify-content-center">
                                                            <input type="radio" class="btn-check" id="btn-main-{{ $i }}"
                                                                   @checked($i == 1) name="period_main"
                                                                   value="{{ $i }}">
                                                            <label
                                                                @class(["btn rounded-pill fw-semibold py-1 px-3 fs-2 m-0", " btn-outline-light-secondary" => $i > 1, "btn-outline-primary" => $i== 1]) for="btn-main-{{ $i }}">Основной</label>
                                                        </div>
                                                    </td>
                                                @endfor
                                            </tr>
                                            ...
                                            {{--  ПЛАТФОРМА --}}
                                            <tr class="platform_header bg-light-secondary ">
                                                <th style="min-width: 35vw" class="p-1 px-2 border-bottom" colspan="3">
                                                    <div class="d-flex justify-content-between">
                                                        <h4 class="m-0 ms-1 text-secondary d-flex align-items-center"
                                                            style="height: 32px">
                                                        ...
                                                        <div class="d-flex justify-content-center align-items-center">
                                                            <div id="neuro_nds">
                                                                <input type="checkbox" class="btn-check" id="platform_nds_cb" @checked((!empty($platforms_have) && !empty($platforms_have[0]) && (bool)$platforms_have[0]?->cb_nds) ?? false)>
                                                                <label class="
                                                                      btn btn-outline-secondary
                                                                      fw-semibold
                                                                      rounded-pill py-1 fs-1 px-2 m-0 me-1
                                                                    " for="platform_nds_cb">НДС</label>
                                                            </div>

                                                            <a class="fast_platform_add d-flex align-items-center" href="javascript:void(0);" onclick="javascript:platform_add();">
                                            ...
                                            @for($i = 1; $i <= $rows; $i++)
                                                @php
                                                    $platform = $platform_matrix[$i-1] ?? null;

                                                @endphp
                                                <tr @class(["platform once", "d-none" => empty($platform), "scenario_selected" => !empty($platform)]) num="{{ $i }}">
                                                    <td style="width: 20px; height: 240px" class="p-1 px-2 pt-2">
                                                        <div class="d-flex flex-column align-items-center"
                                                             style="width: 20px; height: 100%; align-items: stretch;">
                                                            <div
                                                                class="flex-grow-1 d-flex flex-column align-items-center">
                                                                <div class="form-check form-check-inline m-0"
                                                                     style="margin-left: 7px!important">

                                                                    <input name="platform[{{ $i }}][cb_process]"
                                                                           class="cb_process form-check-input secondary check-light-primary "
                                                                           type="checkbox"
                                                                           value="1"
                                                                        @checked(!empty($platform) ? $platform['cb_process'] ?? false : true)
                                                                    >
                                                                </div>
                                                            </div>

                                                            <x-ui.icon.solid icon="fa-xmark"
                                                                             @class(["soft_delete text-danger cursor-pointer fs-6 mb-1"]) onclick="javascript:platform_delete($(this))"/>
                                                        </div>
                                                    </td>
                                                    <td style="width: 20px" class="p-1 px-2 text-center pt-2"><span
                                                            class="num">{{ $i }}</span>.
                                                    </td>
                                                    <td class="p-0 pt-2 soft_selector">
                                                        <div class="d-flex">
                                                            <div class="w-50">
                                                                ...
                                                                <textarea name="platform[{{ $i }}][extended]"
                                                                          class="platform_extended"
                                                                          id="{{ \Illuminate\Support\Str::uuid() }}">{{ $platform['description'] ?? __('proposal.textarea__platform_extended') }}</textarea>
                                                            </div>
                                                            <div class="w-50">
                                                                <div class="mb-1">Примечание</div>
                                                                <textarea name="platform[{{ $i }}][notice]"
                                                                          class="platform_notice"
                                                                          id="{{ \Illuminate\Support\Str::uuid() }}">{{ $platform['notice'] ?? __('proposal.textarea__platform_notice') }}</textarea>
                                                            </div>
                                                        </div>
                                                    ...
                                                    @for($j = 1; $j <= $columns; $j++)
                                                        @php
                                                            $variant = $proposal_variants[$j - 1] ?? null;

                                                            if(!empty($variant) && !empty($platform)) {
                                                                $cell = $platform['cells'][$variant->id] ?? null;
                                                                $cost = $cell->cost ?? 0;
                                                                switch($variant->period_type) {
                                                                    case "year":
                                                                    case "pilot":
                                                                        $cost /= $variant->period_value;
                                                                        break;
                                                                }
                                                            } else {
                                                                $cell = null;
                                                                $cost = round($cost_rules[0][1]['y'] * $currency_koef, 2);
                                                                if(!empty($variant)) {
                                                                    switch($variant->period_type) {
                                                                        case "unlimited":
                                                                            $cost *= 3;
                                                        ...
                                                        @endphp
                                                        <td column="{{ $j }}" @class(["border-start p-1", "column_hl" => $j == 1, "d-none" => $j > $proposal_variants->count() ])>
                                                            <div class="cell">
                                                                <div class="form-check d-flex justify-content-between">
                                                                    <input
                                                                        name="platform_cell[{{ $i }}][{{ $j }}][active]"
                                                                        class="active form-check-input mt-4 me-1"
                                                                        type="checkbox" id="flexCheckDefault"
                                                                        @checked($i > count($platform_matrix) || $j > count($proposal_variants) || !empty($cell['count']))
                                                                        value="1">

                                                                    <div class="cell-active flex-grow-1">
                                                                        <div
                                                                            class="d-flex justify-content-between fs-1">
                                                                            <span class="text-nowrap fs-3">Кол-во</span>
                                                                            <span
                                                                                class="text-nowrap fs-3">Скидка (%)</span>
                                                                        </div>
                                                                        <div class="input-group">
                                                                            <input
                                                                                name="platform_cell[{{ $i }}][{{ $j }}][count]"
                                                                                type="number" min="1" max="999999"
                                                                                value="<?=$cell->count ?? 1 ?>"
                                                                                class="count form-control p-1 fs-3 text-end"
                                                                                aria-label="Text input with checkbox">
                                                                            <input
                                                                                name="platform_cell[{{ $i }}][{{ $j }}][discount]"
                                                                                type="number" min="0" max="99"
                                                                                value="<?=$cell->discount ?? 0 ?>"
                                                                                class="discount form-control p-1 fs-3 text-end"
                                                                                aria-label="Text input with checkbox">
                                                                        </div>

                                                                        <div
                                                                            class="text-start mt-1 fs-3 text-secondary">
                                                                            <input type="hidden"
                                                                                   name="platform_cost[{{ $i }}][{{ $j }}]"
                                                                                   value="{{ $cost }}"
                                                                                   class="fs-1 p-0 inp_cost_cell">
                                                                            <a class="cost_cell"
                                                                               href="javascript:void(0);"
                                                                               onclick="javascript:platform_change_cost($(this));">0</a> {{ $cur_symbol }}

                                                                            <span class="fw-bold text-nowrap">
                                                                               <x-ui.icon.regular icon="fa-arrow-right"
                                                                                                  class="mx-1"/>
                                                                               <span class="cost_cell_total">0</span> {{ $cur_symbol }}
                                                                           </span>
                                                                        </div>

                                                                        <div class="fs-2 d-flex align-items-center mt-2 justify-content-start d-none">
                                                                            <input name="platform_cell[{{ $i }}][{{ $j }}][nds]" class="form-check-input secondary me-1 cb_nds" type="checkbox" id="platform_nds_{{ $i }}_{{ $j }}" value="1"
                                                                                @checked($cell->cb_nds ?? false)
                                                                            >
                                            ...
                                            <tr class="common_platform_add">
                                                <td colspan="3">
                                                    <a href="javascript:void(0);" onclick="javascript:platform_add();">
                                            ...
                                            <tr class="soft_header bg-light-primary d-none">
                                                <th style="min-width: 35vw" class="p-1 px-2 border-bottom" colspan="3">
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        <h4 class="m-0 ms-1 text-primary d-flex align-items-center"
                                                            style="height: 32px">
                                                            <x-ui.icon.regular icon="fa-circle-1" class="me-2"/>
                                                            ПО
                                                        </h4>

                                                        <a class="fast_soft_add d-flex align-items-center"
                                                           href="javascript:void(0);" onclick="javascript:soft_add();">
                                            ...
                                            @for($i = 1; $i <= $rows; $i++)
                                                @php
                                                    $soft = $proposal->software[$i - 1] ?? null;
                                                @endphp
                                                <tr @class(["soft once", "d-none" => $i >= 1 && empty($soft)])>
                                                    <td style="width: 20px; height: 240px" class="p-1 px-2 pt-2">
                                                        <div class="d-flex h-100">
                                                            <div class="handler"></div>
                                                            <div
                                                                class="d-flex flex-column align-items-center p-1 px-2 pt-2"
                                                                style="width: 20px; height: 100%; align-items: stretch;">
                                                                <div
                                                                    class="flex-grow-1 d-flex flex-column align-items-center">
                                                                    <div class="form-check form-check-inline m-0"
                                                                         style="margin-left: 7px!important">
                                                                        <input name="soft[{{ $i }}][cb_process]"
                                                                               class="cb_process form-check-input primary check-light-primary "
                                                                               type="checkbox"
                                                                               value="1" @checked($soft->cb_process ?? true)>
                                                                    </div>

                                                                    <a class="mt-3" href="javascript:void(0);"
                                                                       onclick="javascript:$(this).parents('tr').find('.select2_softs').select2('open');">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <x-ui.icon.solid icon="fa-xmark"
                                                                                     @class(["soft_delete text-danger cursor-pointer fs-6 mb-1"]) onclick="javascript:soft_delete($(this))"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <input type="hidden" value="{{ $i * 100 }}"
                                                               name="soft[{{ $i }}][sort]" class="sort">
                                                    </td>
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="w-50">
                                                                <div class="select2_softs_container">
                                                                    <x-ui.select.single class="select2_softs"
                                                                                        :items="$softs" id="id"
                                                                                        valueName="name"></x-ui.select.single>
                                                                </div>
                                                                <div class="mb-1">Описание</div>
                                                                <textarea name="soft[{{ $i }}][extended]"
                                                                          class="soft_extended"
                                                                          id="{{ \Illuminate\Support\Str::uuid() }}">{!! $soft->description ?? null !!}</textarea>
                                                            </div>
                                                            <div class="w-50">
                                                                <div class="mb-1">Примечание</div>
                                                                <textarea name="soft[{{ $i }}][notice]"
                                                                          class="soft_notice"
                                                                          id="{{ \Illuminate\Support\Str::uuid() }}">{!! $soft->notice ?? null !!}</textarea>
                                                            </div>
                                                        </div>
                                                    ...
                                                    @for($j = 1; $j <= $columns; $j++)
                                                        @php
                                                            $variant = $proposal_variants[$j - 1] ?? null;
                                                            if(!empty($variant) && !empty($soft)) {
                                                                $cell = $variant->proposal_software->where('proposal_software_id', $soft->id)->first() ?? null;
                                                        ...
                                                        <td style="height: 240px"
                                                            column="{{ $j }}" @class(["border-start p-1", "column_hl" => $j == 1, "d-none" => $j > $columns_show && empty($cell)])>
                                                            <div class="h-100 d-flex flex-column">
                                                                <div class="cell soft_cell flex-grow-1">
                                                                    <div
                                                                        class="form-check d-flex justify-content-between align-items-start flex-grow-0 m-1 h-100">
                                                                        <input
                                                                            name="soft_cell[{{ $i }}][{{ $j }}][active]"
                                                                            class="active form-check-input mt-3 me-1"
                                                                            type="checkbox" value="1"
                                                                            id="flexCheckDefault"
                                                                            @checked($i > count($proposal->software) || $j > count($proposal_variants) || !empty($cell['count'])) value="1">

                                                                        <div
                                                                            class="cell-active h-100 d-flex flex-column">
                                                                            <div class="flex-grow-1">
                                                                                <div
                                                                                    class="d-flex justify-content-between fs-1">
                                                                                    <span
                                                                                        class="text-nowrap">Стоимость</span>
                                                                                    <span
                                                                                        class="text-nowrap">Кол-во</span>
                                                                                    <span
                                                                                        class="text-nowrap">Скидка</span>
                                                                                </div>
                                                                                <div class="input-group">
                                                                                    <input
                                                                                        name="soft_cell[{{ $i }}][{{ $j }}][cost]"
                                                                                        type="number" min="1"
                                                                                        max="999999"
                                                                                        value="{{ $cell->cost ?? 0 }}"
                                                                                        class="cost form-control p-0 py-1 fs-1 text-end"
                                                                                        style="width: 30px;">
                                                                                    <input
                                                                                        name="soft_cell[{{ $i }}][{{ $j }}][count]"
                                                                                        type="number" min="0" max="9999"
                                                                                        value="{{ $cell->count ?? 0 }}"
                                                                                        class="count form-control p-0 py-1 fs-1 text-end"
                                                                                        style="width: 25px;">
                                                                                    <input
                                                                                        name="soft_cell[{{ $i }}][{{ $j }}][discount]"
                                                                                        type="number" min="0" max="99"
                                                                                        value="{{ $cell->discount_customer ?? 0 }}"
                                                                                        class="discount form-control p-0 py-1 fs-1 text-end">
                                                                                </div>

                                                                                <div
                                                                                    class="fs-2 d-flex align-items-center mt-2 justify-content-start">
                                                                                    <input
                                                                                        name="soft_cell[{{ $i }}][{{ $j }}][nds]"
                                                                                        class="active form-check-input secondary me-1 cb_nds"
                                                                                        type="checkbox"
                                                                                        id="soft_nds_{{ $i }}_{{ $j }}"
                                                                                        value="1" @checked($cell->cb_nds ?? true)>
                                                                                    <label
                                                                                        class="form-check-label fs-1 fw-normal m-0 ms-1"
                                                                                        for="soft_nds_{{ $i }}_{{ $j }}">НДС</label>
                                                                                </div>

                                                                                <div
                                                                                    class="fs-2 d-flex align-items-center mt-2 justify-content-start">
                                                                                    <input
                                                                                        name="soft_cell[{{ $i }}][{{ $j }}][partner]"
                                                                                        class="active form-check-input secondary me-1 cb_partner"
                                                                                        type="checkbox"
                                                                                        id="soft_partner_{{ $i }}_{{ $j }}"
                                                                                        value="1" @checked($cell->cb_partner_discount ?? false)>
                                                                                    <label
                                                                                        class="form-check-label fs-1 fw-normal m-0 ms-1"
                                                                                        for="soft_partner_{{ $i }}_{{ $j }}">Учитывать
                                                                                        скидку партнёра</label>
                                                                                </div>
                                                                                <div class="text-end">
                                                                                    <span
                                                                                        class="text-start fs-2 text-secondary">
                                                                                       <span
                                                                                           class="soft_cost_total">0</span> {{ $cur_symbol }}
                                                                                       <span
                                                                                           class="fw-bold text-nowrap discount_pad d-none">
                                                                                           <x-ui.icon.regular
                                                                                               icon="fa-arrow-right"
                                                                                               class="mx-1"/>
                                                                                           <span
                                                                                               class="soft_cost_total_with_discount">0</span> {{ $cur_symbol }}
                                                                                       </span>
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="text-end">
                                                                                <a href="javascript:void(0)"
                                                                                   onclick="javascript:copy_soft($(this))"
                                                                                   class="m-1 link" style="opacity: .4">
                                            ...
                                            <tr class="scenario_header bg-light-danger">
                                                <th style="min-width: 35vw" class="p-1 px-2 border-bottom sort_star"
                                                    colspan="3">
                                                    <div class="d-flex justify-content-between">
                                                        <h4 class="m-0 ms-1 text-danger d-flex align-items-center"
                                                            style="height: 32px">
                                                        ...
                                                        <div class="d-flex justify-content-center align-items-center">
                                                            <div>
                                                                <input type="checkbox" class="btn-check"
                                                                       id="neuro_nds_cb" @checked((!empty($scenarios_have) && !empty($scenarios_have[0]) && (bool)$scenarios_have[0]?->cb_nds) ?? false)>
                                                                <label class="
                                                            ...
                                                            <a class="fast_scenario_add d-flex align-items-center"
                                                               href="javascript:void(0);"
                                                               onclick="javascript:scenario_add();">
                                                                <x-ui.icon.regular
                                                                    icon="fa-circle-plus fs-7 text-danger"/>
                                            ...
                                            @for($i = 1; $i <= $rows; $i++)
                                                @php
                                                    $scenario = $scenario_matrix[$i-1] ?? null;
                                                    $has_mnemonic = !empty($scenario['mnemonic_name']);
                                                @endphp
                                                <tr @class(["scenario once", "d-none" => empty($scenario), "scenario_selected" => !empty($scenario)]) num="{{ $i }}">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex flex-column align-items-center"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-check form-check-inline m-0"
                                                                             style="margin-left: 7px!important">
                                                                            <input name="scenario[{{ $i }}][cb_process]"
                                                                                   class="cb_process form-check-input danger check-light-danger "
                                                                                   type="checkbox"
                                                                                   value="1"
                                                                                @checked($scenario['cb_process'] ?? (empty($scenario) ? true : false))
                                                                            >
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div
                                                                    class="d-flex flex-column justify-content-center align-items-center">
                                                                    <x-ui.icon.solid icon="fa-xmark"
                                                                                     @class(["neuro_delete text-danger cursor-pointer fs-6 mb-1"]) onclick="javascript:scenario_delete($(this))"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <input type="hidden" value="{{ $i * 100 }}"
                                                               name="scenario[{{ $i }}][sort]" class="sort">
                                                    ...
                                                    <td class="scenario_selector p-0">
                                                        <div class="d-flex pt-2">
                                                            <div class="flex-grow-1">
                                                                <div class="mb-1">Сценарий</div>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-grow-1">
                                                                        <x-ui.select.single
                                                                            name="scenario[{{ $i }}][scenario]"
                                                                            class="select2"
                                                                            value="{{ $scenario['scenario_id'] ?? null }}"
                                                                            :items="$scenarios" id="id"
                                                                            valueName="name"></x-ui.select.single>
                                                                    </div>
                                                                    <x-ui.icon.regular icon="fa-text"
                                                                                       @class(["ms-1 cursor-pointer", "invisible" => $has_mnemonic]) onclick="javascript:$(this).parents('.scenario_selector').find('.mnemonic_pad').removeClass('d-none'); $(this).addClass('invisible')"/>
                                                                </div>

                                                                <div @class(["mnemonic_pad", "d-none" => !$has_mnemonic])>
                                                                    <div class="fs-1">Альтернативное название
                                                                        (отображается в КП)
                                                                    </div>
                                                                    <input name="scenario[{{ $i }}][mnemonic_name]"
                                                                           type="text"
                                                                           class="form-control fs-2 py-1 px-2"
                                                                           value="{{ $scenario['mnemonic_name'] ?? '' }}">
                                                                </div>

                                                                @if(!empty($scenario['real_name']) && $scenario['scenario_id'] > 0 && $scenario['real_name'] !== $scenarios[$scenario['scenario_id']]->name )
                                                                    <x-ui.notification.light type="danger"  @class(['real_name_pad', 'mt-2 d-flex p-2'])>
                                                                        <x-ui.icon.regular icon="fa-solid fa-triangle-exclamation" class="text-danger fs-5 me-2 mt-1 fw-normal"/>
                                                                        <div>
                                                                            <div><mark>{{ $scenario['real_name'] ?? '' }}</mark></div>
                                                                            <div class="mt-1"><input type="checkbox" name="scenario[{{ $i }}][real_sync]" value="1"> Обновить на актуальное</div>
                                                                            <input type="hidden" name="scenario[{{ $i }}][real_name]" value="{{ $scenario['real_name'] }}">
                                                                        </div>
                                                                    </x-ui.notification.light>
                                                                @endif
                                                            </div>
                                                            <div class="ms-3 w-50">
                                                                <div class="mb-1">Комментарий</div>
                                                                <textarea class="neuro_comment"
                                                                          id="{{ \Illuminate\Support\Str::uuid() }}"
                                                                          height="70"
                                                                          name="scenario[{{ $i }}][comment]">{!! $scenario['comment'] ?? null !!}</textarea>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    @for($j = 1; $j <= $columns; $j++)
                                                        @php
                                                            $variant = $proposal_variants[$j - 1] ?? null;
                                                            if(!empty($variant) && !empty($scenario)) {
                                                                $cell = $scenario['cells'][$variant->id] ?? null;
                                                                $cost = $cell->cost ?? 0;
                                                                switch($variant->period_type) {
                                                                    case "year":
                                                                    case "pilot":
                                                                ...
                                                                if(!empty($scenario['scenario_id'])) {
                                                                    $instance = \App\Modules\Pub\Scenario\Models\Scenario::find($scenario['scenario_id']);
                                                                    $cost = $instance->cost_year ?? 0;
                                                                } else {
                                                                    $cost = 0;
                                                                }
                                                                $cell = null;
                                                        ...
                                                        <td column="{{ $j }}" @class(["border-start p-1", "column_hl" => $j == 1, "d-none" => $j > $proposal_variants->count() ])>
                                                            <div class="cell">
                                                                ...
                                                                <div class="form-check d-flex justify-content-between">
                                                                    <input name="cell[{{ $i }}][{{ $j }}][active]"
                                                                           class="active form-check-input mt-3 me-1"
                                                                           type="checkbox" id="flexCheckDefault"
                                                                           @checked($i > count($scenario_matrix) || $j > count($proposal_variants) || !empty($cell['count']))
                                                                           value="1">
                                                                    <div class="cell-active">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input
                                                                                ...
                                                                                type="number" min="1" max="999999"
                                                                                value="{{ $cell->count ?? 1 }}"
                                                                                class="count form-control p-1 fs-2 text-end"
                                                                                aria-label="Text input with checkbox">
                                                                            <input
                                                                                name="cell[{{ $i }}][{{ $j }}][discount]"
                                                                                type="number" min="0" max="99"
                                                                                value="{{ $cell->discount ?? 0 }}"
                                                                                class="discount form-control p-1 fs-2 text-end"
                                                                                aria-label="Text input with checkbox">
                                                                        </div>

                                                                        <div class="text-start fs-2 text-secondary">
                                                                            <input type="hidden"
                                                                                   name="cost[{{ $i }}][{{ $j }}]"
                                                                                   value="{{ $cost ?? 0 }}"
                                                                                   class="fs-1 p-0 inp_cost_cell">
                                                                            ...
                                                                            <a class="cost_cell"
                                                                               href="javascript:void(0);"
                                                                               onclick="javascript:setForcedNeuroCost($(this));">0</a> {{ $cur_symbol }}
                                                                        ...
                                                                        <div
                                                                            class="fs-2 d-flex align-items-center mt-2 justify-content-start d-none">
                                                                            <input name="cell[{{ $i }}][{{ $j }}][nds]"
                                                                                   class="active form-check-input secondary me-1 cb_nds"
                                                                                   type="checkbox"
                                                                                   id="nds_{{ $i }}_{{ $j }}"
                                                                                   value="1" @checked($cell->cb_nds ?? (!empty($scenarios_have) && !empty($scenarios_have[0]) && (bool)$scenarios_have[0]?->cb_nds) ?? false)>
                                                                            <label
                                                                                class="form-check-label fs-1 fw-normal m-0 ms-1"
                                                                                for="nds_{{ $i }}_{{ $j }}">НДС</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <tr class="work_header bg-light-warning">
                                                <th style="min-width: 35vw" class="p-1 px-2 border-bottom" colspan="3">
                                                    <div class="d-flex justify-content-between">
                                                        <h4 class="m-0 ms-1 text-warning d-flex align-items-center"
                                                            style="height: 32px">
                                                            <x-ui.icon.regular icon="fa-person-digging" class="me-2"/>
                                                            Работы
                                                        </h4>

                                                        <a class="fast_work_add d-flex align-items-center"
                                                           href="javascript:void(0);" onclick="javascript:work_add();">
                                            ...
                                            @for($i = 1; $i <= $rows; $i++)
                                                @php
                                                    $work = $proposal->works[$i - 1] ?? null;
                                                @endphp
                                                <tr @class(["work once", "d-none" => $i >= 1 && empty($work)])>
                                                    <td style="width: 20px; height: 240px" class="p-1 px-2 pt-2">
                                                        <div class="d-flex h-100">
                                                            <div class="handler"></div>
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="form-check form-check-inline m-0"
                                                                         style="margin-left: 7px!important">
                                                                        <input name="work[{{ $i }}][cb_process]"
                                                                               class="cb_process form-check-input warning check-light-warning "
                                                                               type="checkbox"
                                                                               value="1" @checked($work->cb_process ?? true)>
                                                                    </div>

                                                                    <a class="mt-3" href="javascript:void(0);"
                                                                       onclick="javascript:$(this).parents('tr').find('.select2_works').select2('open');">
                                                                        <x-ui.icon.solid icon="fa-bolt-lightning"
                                                                                         class="fs-6"/>
                                                                    </a>
                                                                </div>
                                                                ...
                                                                <div
                                                                    class="d-flex flex-column justify-content-center align-items-center">
                                                                    <x-ui.icon.solid icon="fa-xmark"
                                                                                     @class(["soft_delete text-danger cursor-pointer fs-6 mb-1"]) onclick="javascript:work_delete($(this))"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <input type="hidden" value="{{ $i * 100 }}"
                                                               name="work[{{ $i }}][sort]" class="sort">
                                                    </td>
                                                    <td style="width: 20px" class="p-1 px-2 text-center pt-2"><span
                                                            class="num">{{ $i }}</span>.
                                                    </td>
                                                            ...
                                                            <div class="w-50">
                                                                <div class="select2_works_container">
                                                                    <select class="select2_works">
                                                                        @foreach($works as $select_work)
                                                                            <option value="{{ $select_work->id }}"
                                                                                    data-lang="{{ $select_work->lang }}">{{ $select_work->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="mb-1">Описание</div>
                                                                <textarea name="work[{{ $i }}][extended]"
                                                                          class="work_extended"
                                                                          id="{{ \Illuminate\Support\Str::uuid() }}">{!! $work->description ?? null !!}</textarea>
                                                            </div>
                                                            <div class="w-50">
                                                                <div
                                                                ...
                                                                <textarea name="work[{{ $i }}][notice]"
                                                                          class="work_notice"
                                                                          id="{{ \Illuminate\Support\Str::uuid() }}">{!! $work->notice ?? null !!}</textarea>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    @for($j = 1; $j <= $columns; $j++)
                                                        @php
                                                            $variant = $proposal_variants[$j - 1] ?? null;
                                                            if(!empty($variant) && !empty($work)) {
                                                                $cell = $variant->proposal_works->where('proposal_work_id', $work->id)->first() ?? null;
                                                            } else {
                                                                $cell = null;
                                                            }
                                                        ...
                                                        @endphp
                                                        <td style="height: 240px"
                                                            column="{{ $j }}" @class(["border-start p-1", "column_hl" => $j == 1, "d-none" => $j > $columns_show])>
                                                            <div class="h-100 d-flex flex-column">
                                                                <div class="cell work_cell flex-grow-1">
                                                                    <div
                                                                        class="form-check d-flex justify-content-between align-items-start flex-grow-0 m-1">
                                                                        <input
                                                                            name="work_cell[{{ $i }}][{{ $j }}][active]"
                                                                            class="active form-check-input mt-3 me-1"
                                                                            type="checkbox" value="1"
                                                                            id="flexCheckDefault"
                                                                            value="1" @checked($i > count($proposal->works) || $j > count($proposal_variants) || !empty($cell['count']))>


                                                                        <div class="cell-active flex-grow-1">
                                                                            <div class="d-flex justify-content-between fs-1">
                                                                                <span class="text-nowrap fs-2">Стоимость</span>
                                                                                <span class="text-nowrap fs-2">Часов</span>
                                                                            </div>
                                                                            <div class="input-group">
                                                                                <input
                                                                                    name="work_cell[{{ $i }}][{{ $j }}][cost]"
                                                                                    type="number" min="1" max="999999"
                                                                                    value="{{ $cell->cost ?? 0 }}"
                                                                                    class="cost form-control p-1 fs-1 text-end"
                                                                                    style="min-width: 60px">
                                                                                <input
                                                                                    name="work_cell[{{ $i }}][{{ $j }}][count]"
                                                                                    type="number" min="0" max="9999"
                                                                                    value="{{ $cell->count ?? 0 }}"
                                                                                    class="count form-control p-1 fs-1 text-end">
                                                                            </div>

                                                                            <div class="fs-2 d-flex align-items-center mt-1 justify-content-start" style="margin-left: 23px">
                                                                                <input
                                                                                    name="work_cell[{{ $i }}][{{ $j }}][nds]"
                                                                                    class="active form-check-input secondary me-1 cb_nds"
                                                                                    type="checkbox"
                                                                                    id="work_nds_{{ $i }}_{{ $j }}"
                                                                                    value="1" @checked($cell->cb_nds ?? true)>
                                                                                <label class="form-check-label fs-3 fw-normal m-0 ms-1" for="work_nds_{{ $i }}_{{ $j }}">включить НДС</label>
                                                                            </div>
                                                                            ...
                                                                            {{--                                                                                    <label class="form-check-label fs-3 fw-normal m-0 ms-1" for="work_partner_{{ $i }}_{{ $j }}">Учитывать скидку партнёра</label>--}}
                                                                            {{--                                                                                </div>--}}


                                                                            <div class="d-flex justify-content-between fs-1 mt-3">
                                                                                <span class="text-nowrap fs-2">Скидка клиента</span>
                                                                            </div>
                                                                            <div class="d-flex align-items-center justify-content-start">
                                                                                <input
                                                                                    style="width: 60px"
                                                                                    name="work_cell[{{ $i }}][{{ $j }}][discount]"
                                                                                    type="number" min="0" max="99"
                                                                                    value="{{ $cell->discount_customer ?? 0 }}"
                                                                                    class="discount form-control p-1 fs-3 text-end">

                                                                                <span class="text-nowrap">
                                                                                        = <span class="amount_discount">0</span> {{ $cur_symbol }}
                                                                                    </span>
                                                                            </div>


                                                                            <div class="d-flex justify-content-between fs-1 mt-3">
                                                                                <span class="text-nowrap fs-2">Скидка партнёра</span>
                                                                            </div>
                                                                            <div class="d-flex align-items-center justify-content-start">
                                                                                <input
                                                                                    style="width: 60px"
                                                                                    name="work_cell[{{ $i }}][{{ $j }}][discount_partner]"
                                                                                    type="number" min="0" max="99"
                                                                                    value="{{ $cell->discount_partner ?? 0 }}"
                                                                                    class="discount_partner form-control p-1 fs-3 text-end">

                                                                                <span class="text-nowrap ms-1">
                                                                                    = <span class="amount_partner">0</span> {{ $cur_symbol }}
                                                                                </span>
                                                                            </div>
                                                                            ...
                                                                            <div class="mt-3 text-start fs-3 text-secondary">
                                                                                =
                                                                                <span class="work_cost_total">0</span> {{ $cur_symbol }}
                                                                                <span class="fw-bold text-nowrap discount_pad d-none">
                                                                                       <x-ui.icon.regular icon="fa-arrow-right" class="mx-1"/>
                                                                                       <span class="work_cost_total_with_discount">0</span> {{ $cur_symbol }}
                                                                                   </span>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div>
                                                                    <a href="javascript:void(0)"
                                                                       onclick="javascript:copy_work($(this))"
                                                                       class="m-1 link" style="opacity: .4">
                                                                        <x-ui.icon.regular icon="fa-copy"/>
                                                                    </a>
                                                                </div>
                                            ...
                                            <tr class="platform_partner">
                                                ...
                                                @for($i = 1; $i <= $columns; $i++)
                                                    @php
                                                        $variant = $proposal_variants[$i - 1] ?? null;
                                                    @endphp

                                                    <td column="{{ $i }}" @class(["border-start border-bottom flex-grow-0  py-2", "d-none" => $i > $proposal_variants->count(), "column_hl" => $i == 1])  style="width: 140px!important">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <input
                                                                value="{{ $variant->platform_discount_partner_p ?? 0}}"
                                                                name="partner_platform_discount[{{ $i }}]" type="number" min="0" max="99" class="partner form-control p-1 fs-2 text-end" style="width: 42px">

                                                            <div class="text-end flex-grow-1 text-nowrap ms-2">
                                                                <span class="column_subtotal fs-3">0</span> {{ $cur_symbol }}
                                                            </div>
                                                        </div>
                                                    </td>
                                                @endfor
                                            ...
                                            <tr class="neuro_partner">
                                                ...
                                                @for($i = 1; $i <= $columns; $i++)
                                                    ...
                                                    <td column="{{ $i }}" @class(["border-start border-bottom flex-grow-0  py-2", "d-none" => $i > $proposal_variants->count(), "column_hl" => $i == 1])  style="width: 140px!important">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <input
                                                                value="{{ $variant->neuro_discount_partner_p ?? 0}}"
                                                                name="partner_neuro_discount[{{ $i }}]" type="number" min="0" max="99" class="partner form-control p-1 fs-2 text-end" style="width: 42px">
                                            ...
                                            <tr class="platform_total">
                                                ...
                                                @for($i = 1; $i <= $columns; $i++)
                                                    <td column="{{ $i }}"
                                                        @class(["border-start border-bottom flex-grow-0 py-2", "d-none" => $i > $proposal_variants->count(), "column_hl" => $i == 1])  style="width: 140px!important">
                                                        <div class="text-end fs-3 text-nowrap">
                                                            <span class="column_platform_subtotal cursor-help"
                                                                  title="+ ПО = 0 {{ $cur_symbol }}">0</span> {{ $cur_symbol }}
                                                        </div>
                                                        <div class="fs-2 text-end nds text-warning d-none">НДС: <span class="amount">0</span> {{ $cur_symbol }}</div>
                                                    </td>
                                                @endfor
                                            </tr>
                                            ...
                                            <tr class="soft_total">
                                                ...
                                                @for($i = 1; $i <= $columns; $i++)
                                                    <td column="{{ $i }}"
                                                        ...
                                                        <div class="text-end fs-3 text-nowrap">
                                                            <span
                                                                class="column_soft_subtotal">0</span> {{ $cur_symbol }}
                                                        </div>
                                                        <div class="fs-2 text-end nds text-warning d-none">НДС: <span
                                                                class="amount">0</span> {{ $cur_symbol }}</div>
                                                    </td>
                                                @endfor
                                            </tr>
                                            ...
                                            <tr class="total">
                                                ...
                                                @for($i = 1; $i <= $columns; $i++)
                                                    <td column="{{ $i }}"
                                                        @class(["border-start border-bottom flex-grow-0 py-2", "d-none" => $i > $proposal_variants->count(), "column_hl" => $i == 1])  style="width: 140px!important">
                                                        <div class="text-end fs-3 text-nowrap">
                                                            <span class="column_subtotal cursor-help"
                                                                  title="+ ПО = 0 {{ $cur_symbol }}">0</span> {{ $cur_symbol }}
                                                        </div>
                                                        <div class="fs-2 text-end nds text-warning d-none">НДС: <span
                                                                class="amount">0</span> {{ $cur_symbol }}</div>
                                            ...
                                            <tr class="work_total">
                                                ...
                                                @for($i = 1; $i <= $columns; $i++)
                                                    <td column="{{ $i }}"
                                                        ...
                                                        <div class="text-end fs-3 text-nowrap">
                                                            <span
                                                                class="column_work_subtotal">0</span> {{ $cur_symbol }}
                                                        </div>
                                                        <div class="fs-2 text-end nds text-warning d-none">НДС: <span
                                                                class="amount">0</span> {{ $cur_symbol }}</div>
                                                    </td>
                                            ...
                                            <tr class="proposal_nds d-none">
                                                <td colspan="3" class="text-end py-2">
                                                    НДС (<span id="nds_rate">{{ $proposal->nds }}</span>%)
                                                </td>
                                                @for($i = 1; $i <= $columns; $i++)
                                                    <td column="{{ $i }}"
                                                        @class(["border-start border-top border-bottom flex-grow-0 py-2", "d-none" => $i > $proposal_variants->count(), "column_hl" => $i == 1])  style="width: 140px!important">
                                                        <div class="text-end fs-3 text-nowrap">
                                                            <span class="total">0</span> {{ $cur_symbol }}
                                                        </div>
                                                    </td>
                                                @endfor
                                            </tr>
                                    ...
                                    <div class="text-end">
                                        <div>
                                            <button type="button" id="submit"
                                                    class=" btn btn-primary fw-semibold px-6 disabled"
                                                    onclick="javascript:sbm();">
                                                <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="form-check form-check-inline mt-2">
                                                    <input
                                                        class=" form-check-input danger check-outline outline-danger "
                                                        type="checkbox" id="danger2-outline-check" value="1"
                                                        name="new_iteration">
                                                    <label class="form-check-label fw-normal fs-3 text-danger"
                                                           for="danger2-outline-check">Создать новую версию</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@section('js')
    ...
    <script>
        ...
        var mode = 'year';
        var cost_total = 0;
        var scenario_count = {{ count($scenario_matrix) }};
        var platform_count = {{ $platforms_have?->count() ?? 0 }};
        var soft_count = {{ $proposal->software->count() }};
        var work_count = {{ $proposal->works->count() }};
        var columns = 1;
        var cost_source = 'save';
        var work_groups = @json(array_values($work_groups->toArray()));
        var neuroForceCost = @json($neuroForceCost);
        ...
        function scenario_add() {
            ...
            CKEDITOR.replace(ta.attr("id"), {
                height: ta.attr("height"),
                toolbar: [{
                    name: 'basicstyles',
                    items: ['Bold', 'Italic', 'Underline', 'TextColor', 'BGColor']
                }, {name: 'paragraph', items: ['NumberedList', 'BulletedList']}, {name: 'styles', items: ['Styles']}]
            });
        ...
        function sbm() {
            ...
            $.ajax({
                url: "{{ route('api.proposal.update', [$proposal, $proposal->iteration, '_token' => _token() ]) }}",
                type: "POST",
                dataType: "json",
        ...
        $(document).ready(function () {
            ...
            $("tbody#softs").sortable({
                handle: '.handler',
                start: function (event, ui) {
                    // Деактивируем все CKEditor в текущем элементе
                ...
                stop: function (event, ui) {
                    // После завершения перетаскивания, создаем новый экземпляр CKEditor для каждого текстового поля
                    ui.item.find('textarea').each(function () {
                    ...
                    p = 0;
                    $("tbody#softs tr.once").each(function () {
                        p++;
                        $(this).find(".sort").val(p * 100);
                        $(this).find("span.num").html(p);
                    })
                }
            });


            $("tbody#scenarios").sortable({
                handle: '.handler',
                stop: function (event, ui) {
                    p = 0;
                    $("tbody#scenarios tr.once").each(function () {
                        p++;
                        $(this).find(".sort").val(p * 100);
                        $(this).find("span.num").html(p);
                    })
            ...
            $("tbody#works").sortable({
                ...
                stop: function (event, ui) {
                    ...
                    p = 0;
                    $("tbody#works tr.once").each(function () {
                        p++;
                        $(this).find(".sort").val(p * 100);
                        $(this).find("span.num").html(p);
                    })
            ...
            $("#neuro_nds").on("change", function () {
                prop = $(this).prop("checked");
                $(".scenario.once input.cb_nds").prop("checked", prop);
            });

            $("input[name='cost_source']").on("change", function () {
                cost_source = $(this).val();
                table_data_recalc();
            });
            ...
            $(".once:not(.d-none) textarea").each(function () {
                id = $(this).attr("id");
                CKEDITOR.replace(id, {
                    height: $(this).attr("height") ?? 150,
                    toolbar: [
...
// логика при смене языка
            ...
            table_data_recalc();
            $("body").unblock(block_default);
            $("form#form_create.init").removeClass("init");
            form_check();
        });
        ...
        function setForcedNeuroCost(input) {
            ...
            try {
                ...
                bestRuleCount = -1;
                if (cost_rules && cost_rules[scenario_id]) {
                    console.log(cost_rules[scenario_id]);
                    $.each(cost_rules[scenario_id], (rule_count_str, rule) => {
                        const rule_count = parseFloat(rule_count_str);
                        if (rule_count <= count && rule_count > bestRuleCount) {
                            bestRuleCount = rule_count;
                ...
                neuroForceCost[row_num][column_num][scenario_id][bestRuleCount][modeKey] = newValue;
