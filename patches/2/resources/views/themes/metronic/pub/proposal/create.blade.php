                ...
                <div class="card">
                    <form id="form_create">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3">
                                    <label for="tb-fname" class="text-end col-form-label fw-semibold">Название <span class="text-danger">*</span></label>
                                    <input required name="name" type="text" class="form-control " id="tb-fname"
                                           placeholder="" value="{{ old('name') }}">
                                </div>
                                <div class="col-3">
                                    <label for="tb-fname" class="text-end col-form-label fw-semibold">Название (альт.)</label>
                                    <input name="name_alt" type="text" class="form-control " id="tb-fname"
                                           placeholder="" value="">
                                </div>
                                <div class="col-2">
                                    <label for="tb-fname" class="text-end col-form-label fw-semibold">Дата КП <span class="text-danger">*</span></label>
                                    <input required name="date" type="date" class="form-control w-100" id="tb-fname"
                                           placeholder="" value="{{ old('date') }}" style="width: 140px">
                                </div>
                                <div class="col-2">
                                    <label for="tb-fname" class="text-end col-form-label fw-semibold">Менеджер <span class="text-danger">*</span></label>
                                ...
                                <div class="col-1 pe-0">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <input required name="number" type="text" class="form-control fs-2 " id="tb-fname" value=""
                                ...
                                <div class="col-1 pe-0">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <input required name="nds" type="text" class="form-control fs-2 " id="tb-fname" value="{{ \App\Modules\Pub\Constant\Models\Constant::get('nds_rate') }}"
                            ...
                            <div class="mb-5 row">
                                <div class="col-3">
                                    <label for="tb-fname" class="col-sm-4 col-form-label fw-semibold">Компания <span class="text-danger">*</span></label>
                                    <x-ui.select.single  class="select2" name="company" required :items="$companies" id="key" value-name="label" :value="$company_default"></x-ui.select.single>
                                </div>
                                <div class="col-3">
                                    <label for="tb-fname" class="col-sm-4 col-form-label fw-semibold">Партнёр <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-12 position-relative">
                                    ...
                                    <div class=" mt-10 table-responsive" style="clear: both">
                                        ...
                                        <table border="1" class="table table-hover table-bordered border-gray-300" id="table_data" count="0" work_count="0" soft_count="0" platform_count="0" column="1" style="width: auto; min-width: 100%">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1 d-flex align-items-center period_type_selector">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <select name="period[{{ $i }}]" class="form-select period p-1 fs-3 flex-grow-1" prev-value="year">
                                                                    <option value="pilot">Пилот</option>
                                                                    <option value="year" selected>Годовая</option>
                                                                    <option value="unlimited">Безлимит</option>
                                                                </select>
                                                                <input name="period_value[{{ $i }}]" maxlength="2" type="number"  class="form-control p-1 fs-3 flex-grow-0 text-center count" style="width: 50px" value="1" prev-value="1">
                                            ...
                                            @for($i = 1; $i <= $columns; $i++)
                                                <td column="{{ $i }}" @class(["border-start border-bottom flex-grow-0 border-bottom-0 p-0 py-2", "d-none" => $i > 1, "column_hl" => $i == 1])  style="width: 140px!important">
                                                    <div class="d-flex justify-content-center">
                                                        ...
                                                        <label @class(["btn rounded-pill fw-semibold py-1 px-3 fs-2 m-0", " btn-outline-light-secondary" => $i > 1, "btn-outline-primary" => $i== 1]) for="btn-main-{{ $i }}">Основной</label>
                                                    </div>
                                                </td>
                                            @endfor
                                        </tr>
                                                            ...
                                                            <td column="{{ $j }}" @class(["border-start p-1", "column_hl" => $j == 1, "d-none" => $j > 1])>
                                                                <div class="cell">
                                                                    <div class="form-check d-flex justify-content-between">
                                                                        <input name="platform_cell[{{ $i }}][{{ $j }}][active]" class="active form-check-input mt-4 me-1" type="checkbox" id="flexCheckDefault" checked value="1">

                                                                        <div class="cell-active flex-grow-1">
                                                                            <div class="d-flex justify-content-between fs-1">
                                                                                <span class="text-nowrap fs-3">Кол-во</span>
                                                                                <span class="text-nowrap fs-3">Скидка (%)</span>
                                                                            </div>
                                                                            <div class="input-group">
                                                                                <input name="platform_cell[{{ $i }}][{{ $j }}][count]" type="number" min="1" max="999999" value="1" class="count form-control p-1 fs-3 text-end" aria-label="Text input with checkbox">
                                                                                <input name="platform_cell[{{ $i }}][{{ $j }}][discount]" type="number" min="0" max="99" value="0" class="discount form-control p-1 fs-3 text-end" aria-label="Text input with checkbox">
                                                                            </div>

                                                                            <div class="text-start mt-1 fs-3 text-secondary">
                                            ...
                                            <tr class="soft_header bg-light-primary d-none">
                                                <th style="min-width: 35vw" class="p-1 px-2 border-bottom" colspan="3">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <a class="fast_soft_add d-flex align-items-center" href="javascript:void(0);" onclick="javascript:soft_add();">
                                                ...
                                                <th style="min-width: 35vw" class="p-1 px-2 border-bottom sort_star" colspan="3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="d-flex justify-content-center align-items-center">
                                                            ...
                                                            <a class="fast_scenario_add d-flex align-items-center" href="javascript:void(0);" onclick="javascript:scenario_add();">
                                                ...
                                                <tr @class(["scenario once", "d-none" => $i >= 1]) num="{{ $i }}">
                                                    ...
                                                    <td class="scenario_selector p-0">
                                                        <div class="d-flex">
                                                            <div class="flex-grow-1 pt-1 w-50 overflow-hidden">
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-grow-1">
                                                                        <x-ui.select.single name="scenario[{{ $i }}][scenario]" class="select2 w-100" :items="$scenarios" id="id" valueName="name"></x-ui.select.single>
                                                                    </div>
                                                                ...
                                                                <div @class(["mnemonic_pad d-none"])>
                                                                    <div class="fs-1">Альтернативное название (отображается в КП)</div>
                                                    ...
                                                    @for($j = 1; $j <= $columns; $j++)
                                                        <td column="{{ $j }}" @class(["border-start p-1", "column_hl" => $j == 1, "d-none" => $j > 1])>
                                                            <div class="cell">
                                                                <div class="form-check d-flex justify-content-between">
                                                                    <input name="cell[{{ $i }}][{{ $j }}][active]" class="active form-check-input mt-4 me-1" type="checkbox" id="flexCheckDefault" checked value="1">
                                                                    ...
                                                                    <div class="cell-active flex-grow-1">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input name="cell[{{ $i }}][{{ $j }}][count]" type="number" min="1" max="999999" value="1" class="count form-control p-1 fs-3 text-end" aria-label="Text input with checkbox">
                                                                            <input name="cell[{{ $i }}][{{ $j }}][discount]" type="number" min="0" max="99" value="0" class="discount form-control p-1 fs-3 text-end" aria-label="Text input with checkbox">
                                                                        </div>

                                                                        <div class="text-start fs-3 text-secondary mt-1">
                                            ...
                                            <tr class="work_header bg-light-warning">
                                                <th style="min-width: 35vw" class="p-1 px-2 border-bottom" colspan="3">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <a class="fast_work_add d-flex align-items-center" href="javascript:void(0);" onclick="javascript:work_add();">
                                                            ...
                                                            <div class="h-100 d-flex flex-column">
                                                                <div class="cell work_cell flex-grow-1">
                                                                        <div class="form-check d-flex justify-content-start align-items-start flex-grow-0 m-1">
                                                                            <input name="work_cell[{{ $i }}][{{ $j }}][active]" class="active form-check-input mt-4 me-1" type="checkbox" value="1" id="flexCheckDefault" checked value="1">
                                                                            ...
                                                                            <div class="cell-active flex-grow-1">
                                                                                ...
                                                                                <div class="input-group">
                                                                                    <input name="work_cell[{{ $i }}][{{ $j }}][cost]" type="number" min="1" max="999999" value="7000" class="cost form-control p-1 fs-3 text-end" style="min-width: 60px">
                                                                                    <input name="work_cell[{{ $i }}][{{ $j }}][count]" type="number" min="0" max="9999" value="0" class="count form-control p-1 fs-3 text-end">
                                                                                </div>
...
{{--                                                                                </div>--}}
                                                                                ...
                                                                                <div class="d-flex align-items-center justify-content-start">
                                                                                    <input style="width: 60px" name="work_cell[{{ $i }}][{{ $j }}][discount]" type="number" min="0" max="99" value="0" class="discount form-control p-1 fs-3 text-end">
                                                                                ...
                                                                                <div class="d-flex align-items-center justify-content-start">
                                                                                    <input style="width: 60px" name="work_cell[{{ $i }}][{{ $j }}][discount_partner]" type="number" min="0" max="99" value="0" class="discount_partner form-control p-1 fs-3 text-end">
                                            ...
                                            <tr class="platform_partner">
                                                ...
                                                @for($i = 1; $i <= $columns; $i++)
                                                    <td column="{{ $i }}" @class(["border-start border-bottom flex-grow-0  py-2", "d-none" => $i > 1, "column_hl" => $i == 1])  style="width: 140px!important">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <input name="partner_platform_discount[{{ $i }}]" type="number" min="0" max="99" value="0" class="partner form-control p-1 fs-2 text-end" style="width: 42px">
                                            ...
                                            <tr class="neuro_partner">
                                                ...
                                                @for($i = 1; $i <= $columns; $i++)
                                                    <td column="{{ $i }}" @class(["border-start border-bottom flex-grow-0  py-2", "d-none" => $i > 1, "column_hl" => $i == 1])  style="width: 140px!important">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <input name="partner_neuro_discount[{{ $i }}]" type="number" min="0" max="99" value="0" class="partner form-control p-1 fs-2 text-end" style="width: 42px">
                                            ...
                                            <tr class="platform_total">
                                                ...
                                                @for($i = 1; $i <= $columns; $i++)
                                                    <td column="{{ $i }}" @class(["border-start border-bottom flex-grow-0 py-2", "d-none" => $i > 1, "column_hl" => $i == 1])  style="width: 140px!important">
                                                        ...
                                                        <div class="fs-2 text-end nds text-warning d-none">НДС: <span class="amount">0</span> ₽</div>
                                                    </td>
                                                @endfor
                                            </tr>
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="text-end">
                                        <button type="button" id="submit" class=" btn btn-primary fw-semibold px-6 disabled" onclick="javascript:sbm();">
                                            <div class="d-flex align-items-center">
