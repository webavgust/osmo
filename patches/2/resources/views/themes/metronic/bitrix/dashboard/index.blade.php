...
@section('content')
    ...
    <div id="dashboard">
        ...
        <div class="row g-4 mb-8">
            <div class="col-6 col-md-4 col-xl-2"><x-bitrix.dashboard.sales/></div>
            <div class="col-6 col-md-4 col-xl-2"><x-bitrix.dashboard.licenses/></div>
            <div class="col-6 col-md-4 col-xl-2"><x-bitrix.dashboard.services/></div>
            <div class="col-6 col-md-4 col-xl-2"><x-bitrix.dashboard.devcost/></div>
            <div class="col-6 col-md-4 col-xl-2"><x-bitrix.dashboard.platform/></div>
            <div class="col-6 col-md-4 col-xl-2"><x-bitrix.dashboard.servicesRaw/></div>
        </div>
