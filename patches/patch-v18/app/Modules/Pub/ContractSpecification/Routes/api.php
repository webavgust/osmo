...
Route::group(['prefix' => 'contract_specs', 'middleware' => ['ajax.api']], function () {
    ...
    Route::post('/set_proposal/{spec}', [\App\Modules\Pub\ContractSpecification\Controllers\Api\ApiContractSpecificationController::class, 'set_proposal'])->name('api.contract_spec.set_proposal');
});
