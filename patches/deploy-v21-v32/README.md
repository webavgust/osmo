...
> **Выполнено 15.09.2026.** Прод на `d713cfd`. Резервная копия — `/root/backup/avgmom-2026-09-15_00-18.sql.gz`
> (копия в `W:\Backup\MySQL\avg.mom\2026-09-15`). 16 миграций, 9 SQL-файлов, ключи OSMOVIEW CP в `.env`
> (прежний файл — `.env.before-v21-v32`), проектов по сделкам создано 21 (16 сделок ждут сопоставления
> партнёров), слепков журнала 654. Страницы под админом и обычным пользователем — 200, админ-панель
> обычному — 403. Осталось руками — раздел 4.
