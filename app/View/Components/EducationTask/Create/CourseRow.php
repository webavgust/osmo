...
namespace App\View\Components\EducationTask\Create;
...
class CourseRow extends Component
{
    ...
    public function __construct(EducationTaskCourse $course = null, $num = null)
    {
        $this->uid = $course->id;
        $this->course = $course;
        $this->courses = CourseRepository::getAll();
        $this->program_types = EducationTaskCourse::TYPES;
    ...
    public function render()
    {
        ...
        return view('components.education_task.create.course_row', [
