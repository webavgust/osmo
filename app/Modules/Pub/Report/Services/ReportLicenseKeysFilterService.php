...
class ReportLicenseKeysFilterService
{
    private $filter;
    private $token;
    ...
    public function __construct($token = false)
    {
        ...
        $this->token = $token;
        $this->filter = Cache::get('report.license_keys.filter:' . $this->token);
...
//        }
    ...
    public function setFilter($arFilter)
    {
        ...
        Cache::set('report.license_keys.filter:' . $this->token, $this->filter, 86400);
    ...
    {
        Cache::forget('report.license_keys.filter:' . $this->token);
    }
