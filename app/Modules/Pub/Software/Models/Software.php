...
namespace App\Modules\Pub\Software\Models;

use App\Models\ModuleModel;
use App\Modules\Pub\Company\Models\Company;
use Illuminate\Database\Eloquent\Builder;

class Software extends ModuleModel
{
    protected $fillable = ['name', 'extended', 'notice', 'count', 'type', 'cb_nds', 'cost'];
    protected $casts = ['cb_nds' => 'bool'];
