                ...
                <div class="card">
                    ...
                    <form action="{{ route('access_group.update', $group) }}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                <label for="tb-code" class="col-sm-4 text-end control-label col-form-label">Префикс <span class="text-danger">*</span></label>
                                <div class="col-sm-4">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-4 col-ml">
                                    ...
                                    @if(!$group->accesses()->count())
                                        <button type="button" class=" btn waves-effect waves-light btn-rounded btn-outline-danger ms-2"
