...
@section('body')
            ...
            <div class="card-body p-0">
                <div class="mt-2">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" rows="5" name="text">{!! $note->text !!}</textarea>
                    </div>
                    <div class="mb-1">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input warning check-light-warning" type="checkbox" id="warning2-light-check" value="1" name="favorite" @if($note->favorite) checked @endif >
                ...
                <x-ui.button.outline type="button" btn_type="primary" class="mt-3 w-100 " id="note_submit">
                    Сохранить заметку
                </x-ui.button.outline>
            </div>
        </div>
    ...
    <script>
        ...
        function note_submit(event) {
            ...
            $.ajax({
                url: "{{ route('api.user-notes.edit', [$note, '_token' => _token()]) }}",
                type: "POST",
                ...
                error: function () {
                    toastr.error("Не получилось сохранить заметку", "Это провал!", {
                        progressBar: true,
                        "timeOut": 3000,
                    });
                    $(block_elem).unblock();
