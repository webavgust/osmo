                ...
                <div class="col-12">
                            <div id="filter">
                                @if(auth()->user()->isAdmin())
                                    <button data-url="/url" type="button" class="btn waves-effect waves-light btn-outline-primary btn-progress-bar" onclick="javascript:progress($(this), '{{ route('api.user.sync_all', ['_token' => auth()->user()->ajax_token ]) }}')">
                                        <loader>
