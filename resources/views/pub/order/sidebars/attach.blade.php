    ...
    <div class="card">
        <div class="card-body">
            <div class="card-table">
                <div class="tr">
                    <span class="th">Номер заказа</span>
                    <span class="td">
                        {{ $order->id }}
                     </span>
                </div>
    ...
    <script>
        $(document).ready(function() {
           ...
           $("#attach_to").select2({
               ...
               minimum: 3,
               placeholder: 'Мин. 3 цифры договора' ,
               ajax: {
                   delay: 250,
                   url: '{{ route('api.order_task.list_free', ['_token' => auth()->user()->ajax_token]) }}',
        ...
        function attach_submit() {
            ...
            $.ajax({
                url: "{{ route('api.order_task.attach_order', [$order, '_token' => auth()->user()->ajax_token ]) }}",
                type: "POST",
                dataType: "json",
