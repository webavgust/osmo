        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('neuroservice_group.store') }}" method="POST"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-1">
                                    <input name="sort" type="text" class="form-control" id="tb-sort"
                                           placeholder="" required="" value="{{\App\Modules\Pub\NeuroserviceGroup\Models\NeuroserviceGroup::max('sort') + 100}}"
                                           value="{{ old('sort') }}">
