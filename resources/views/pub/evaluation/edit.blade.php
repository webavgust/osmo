            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 col-xl-8" id="block_main">
                        <form method="post"
                              action="{{ route('evaluation.edit_save', [$evaluation]) }}"
                              id="evaluation_edit">
                            @csrf
                            ...
                            <div class="card mb-1">
                                ...
                                <div class="card-body p-0 structure">
                                    <ul class="objects">
                                        @foreach($evaluation->objects as $i => $object)
                                            <x-evaluation.create.object_row :num="$i + 1" :object="$object"></x-evaluation.create.object_row>
                                        @endforeach
                                    </ul>

                                    <x-ui.button.outline btn_type="info" onclick="javascript:add_object()" class="add_object ms-3 mt-2 mb-3"><i class="fa-thin fa-circle-plus me-1"></i> объект</x-ui.button.outline>
                                </div>
                            </div>
                        </form>
                    </div>
...
{{--                            <object><embed src="" width="100%" height="100%" id="doc_embed"/></object>--}}
                    ...
                    <div class="col-12 col-xl-4" id="block_secondary">
                        <x-ui.a.box id="doc_btn" class="w-100 mb-2" btn_type="primary" href="{{ route('evaluation.box_import', $evaluation) }}">Загрузить документ (PDF, DOCX, XLSX)</x-ui.a.box>
                                ...
                                <div class="card-table">
                                    <x-ui.card.card_table_tr field="Оценщик" required="1">
                                        <x-ui.select.single :items="$responsibles" name="responsible_out"
                                                            ...
                                                            value-name="full_name" value="{{ $evaluation->responsible?->id }}"></x-ui.select.single>
                                    </x-ui.card.card_table_tr>
                                    <x-ui.card.card_table_tr field="Срок исполнения">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Укажите срок" name="period_out" value="{{ $evaluation->period }}">
                                        </div>
                                    </x-ui.card.card_table_tr>
                                </div>
                            </div>
                        ...
                        <x-files.dropzone :files="$files ?? []" mode="evaluation" id="{{ $evaluation->id }}" block="other" name="Файлы"
                                          class="mt-3 mb-0"></x-files.dropzone>

                        <x-ui.button.default btn_type="success" onclick="javascript:form_confirm();" class=" w-100 mt-3"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex align-items-center justify-content-start">
                        ...
                        <input id="paste_count" type="number" class="form-control text-center" min="1" max="100" value="1" style="width: 70px">
                    </div>
                </div>
    ...
    <script>
        ...
        function form_check() {
            ...
            $(".objects > li").each(function() {
                if(0 && !$(this).find(".object_name").val()) {
                ...
                cur_obj.find(".addresses > li").each(function() {
                    ...
                    cur_adr.find(".points > li").each(function() {
                        ...
                        cur_point.find(".measures > li").each(function() {
                            ...
                            count = $(this).find(".measure_count").val()-0;
                            if(count > 1 && !$(this).find(".inp_comment").val()) {
                                error_msg("<b>" + cur_obj.find('h5').html() + "</b>, <b>" + cur_adr.find('h5').html() + "</b> / <b>" + cur_point.find('h5').html() + "</b> / <b>" + $(this).find('h5').html() + "</b>: не указан комментарий");
                            }
