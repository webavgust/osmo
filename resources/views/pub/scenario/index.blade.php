    ...
    <div class="email-app todo-box-container">
        ...
        <div class="left-part list-of-tasks">
            ...
            <div class="scrollable" style="height: 100%">
                <div class="p-3">
                    <a class="waves-effect waves-light btn btn-info d-block" href="{{ route('scenario_group.create') }}" id="add-group">Добавить группу</a>
                </div>
        ...
        <div class="right-part mail-list bg-white overflow-auto">
            <div id="todo-list-container">
                ...
                <div class="todo-listing">
                    ...
                    <div class="">
                        <table class="table customize-table v-middle h-100" id="table_scenarios">
                            <thead class="table-secondary">
                            <tr>
                                <th class="text-secondary ps-3" width="1">Номер</th>
                                <th class="text-secondary px-0" width="1"></th>
                                <th class="text-secondary">Сценарий</th>
                                <th class="text-secondary">Нейросервисы</th>
