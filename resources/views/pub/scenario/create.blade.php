...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card-body border-bottom">
            <h4 class="card-title">Создание сценария</h4>
        </div>
        <form id="scenario_create" action="{{ route('scenario.store', $group) }}" method="POST"
            ...
            <div class="container-fluid">
                <div class="row mt-4">
                    <div class="col-12 col-md-7">
                        ...
                        <div class="mb-3 row">
                            <label for="tb-class"
                                   class="col-4 col-md-2 text-end control-label col-form-label text-nowrap">Сортировка <span
                                    class="text-danger">*</span>
                            </label>
                            <div class="col-4">
                                <input name="sort" type="text" class="form-control" id="tb-class"
                                       placeholder="" required="" value="{{$group->scenarios()->max('sort') + 100}}"
                                       value="{{ old('sort') }}">
                        ...
                        <div class="mb-3 row">
                            <label for="tb-fname"
                                   class="col-4 col-md-2 text-end control-label col-form-label text-nowrap">Название<span
                        ...
                        <div class="mb-3 row">
                            <label for="tb-fname"
                                   class="col-4 col-md-2 text-end control-label col-form-label"></label>
                            <div class="col-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" id="flexCheckDefault" name="active" checked >
                            ...
                            <div class="offset-md-2 col-12 col-md-10">
                                ...
                                <table count="1" id="cost_table" class="table table-bordered w-auto">
                                    ...
                                    <tr class="items">
                                        <td>Штук, от</td>
                                        @for($i = 0; $i < 99; $i++)
                                            <td num="{{ $i }}" @class(["p-0 cost align-content-center", "d-none" => $i > 1]) >
                                                @if($i == 0)
                                                    <input name="cost_rules[{{ $i }}][c]" type="text" class="cost-input cost_c w-100 border-0 p-1 text-center" min="0" readonly value="{{ 1 }}">
                                                @else
                                                    <input name="cost_rules[{{ $i }}][c]" type="text" class="cost-input cost_c w-100 border-0 p-1 text-center" min="0" value="">
                                                @endif
                                            </td>
                                        @endfor
                                    </tr>
                                    <tr class="year">
                                        ...
                                        @for($i = 0; $i < 99; $i++)
                                            <td num="{{ $i }}" @class(["p-0 cost align-content-center", "d-none" => $i > 1]) >
                                                <input name="cost_rules[{{ $i }}][y]" type="text" class="cost-input cost_y w-100 border-0 p-1 text-center" min="0" value="">
                                            </td>
                                        @endfor
                                    </tr>
                                    <tr class="unlimited">
                                        ...
                                        @for($i = 0; $i < 99; $i++)
                                            <td num="{{ $i }}" @class(["p-0 cost align-content-center", "d-none" => $i > 1]) >
                                                <input name="cost_rules[{{ $i }}][u]" type="text" class="cost-input cost_u w-100 border-0 p-1 text-center" min="0" value="">
                                            </td>
                                        @endfor
                                    </tr>
                                    <tr>
                                        <td class="p-0"/>
                                        @for($i = 0; $i < 99; $i++)
                                            <td num="{{ $i }}" @class(["p-0 cost text-center", "d-none" => $i > 1]) >
                                                @if($i > 0)
                                ...
                                {{--                                                    <input name="cost_rules[{{ $i }}][y]" type="number" class="cost_y w-100 border-0 p-1 text-center" min="0" value="">--}}
                                {{--                                                </td>--}}
                                {{--                                                <td class="p-0" width="120">--}}
                ...
                <div class="row justify-content-center mt-4">
                    <div class="col-sm-4 col-ml text-center">
                        <button type="submit" class=" btn btn-info font-weight-medium rounded-pill px-4" disabled id="btn_submit">
