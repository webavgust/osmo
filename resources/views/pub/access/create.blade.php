            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body border-bottom">
                        <h4 class="card-title">Создание доступа в группе "{{ $group->name }}"</h4>
                        <h6 class="card-subtitle mb-0">
                            Здесь описание
                        </h6>
                    </div>
                    <form action="{{ route('access.store', $group) }}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                <label for="tb-code" class="col-sm-4 text-end control-label col-form-label">Кодовое
                                    обозначение<span class="text-danger">*</span></label>
                                <div class="col-sm-4">
                                    <input name="code" type="text" class="form-control " id="tb-code"
                                           placeholder="" required="" value="{{ old('code') ?? $group->prefix }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-1">
                                    <input name="sort" type="text" class="form-control" id="tb-class"
                                           placeholder="" required="" value="{{$group->accesses()->max('sort') + 100}}"
                                           value="{{ old('sort') }}">
                            ...
                            <div class="mb-3 mt-4 row">
                                <label for="tb-class"
                                       class="col-sm-4 text-end control-label col-form-label">Комментарий</label>
                                <div class="col-sm-4">
