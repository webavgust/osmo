    ...
    <script>
        ...
        function boxFormatter(value, row) {
            if(!value) {
                ...
                return `<a class="btn waves-effect waves-light btn-outline-info ms-1 py-1 px-2 fs-1" onclick="javascript:box({href: '{{ route('software.box_extended') }}/` + row.id + `'})" btn_type="info" type="button">
