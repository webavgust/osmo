                ...
                <div class="card">
                    ...
                    <form id="form_create">
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                <label for="tb-fname"
                                       class="col-sm-4 text-end control-label col-form-label">Страна</label>
                                <div class="col-sm-4">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-4 col-ml">
                                    <button type="button" id="submit" class=" btn btn-info font-weight-medium rounded-pill px-4 " onclick="javascript:sbm();">
