            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Подразделение "{{ $department->name }}"</h4>
                                <h6 class="card-subtitle lh-base">
                                    Назначение доступов для подразделения "{{ $department->name }}"
                                </h6>
                                                        ...
                                                        <div class="inner-item d-flex align-items-start">
                                                            <div class="w-100">
                                                                <div class=" checkbox checkbox-info d-flex align-items-start form-check ps-0">
                                                                    ...
                                                                    <x-access.set_row  :group="$department" :access="$access"></x-access.set_row>
    ...
    <script>
        $(document).ready(function() {
            $("form#access input[type='radio']").on("change", function() {
                ...
                $.ajax({
                    url: '{{ route('api.access_set.department', [$department->id, '_token' => auth()->user()->ajax_token]) }}',
                    method: 'post',
                    dataType: 'json',
