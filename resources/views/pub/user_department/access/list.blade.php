                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-10">
                                    <h4 class="card-title">Список подразделений</h4>
                                    <h6 class="card-subtitle lh-base">
                                        Для назначения доступа для подразделения перейдите на детальную страницу группы
                                    </h6>
                                </div>
                                <div class="col-2">
                            ...
                            <table class="table customize-table mb-0 v-middle search-table">
                                ...
                                @foreach($departments as $department)
                                    <tr class="search-items">
                                        ...
                                        <td align="center">
                                            @if($department->accesses_count > 0)
                                                <strong>{{ $department->accesses_count }}</strong>
                                            @else
                                        ...
                                        <td>
                                            <div class="dropdown dropstart">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('access_set.department', $department) }}"><i class="fas fa-edit text-info me-1"></i> Назначить доступы</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
