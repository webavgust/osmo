                ...
                <div class="card">
                    <form id="form_create" class="init">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3">
                                    <label for="tb-fname" class="text-end control-label col-form-label">Название <span
                                            class="text-danger">*</span></label>
                                    <input required name="name" type="text" class="form-control " id="tb-fname"
                                           placeholder="" value="{{ $proposal->name }}">
                                </div>
                                <div class="col-3">
                                    <label for="tb-fname" class="text-end control-label col-form-label">Название
                                        (альт.)</label>
                                    <input name="name_alt" type="text" class="form-control " id="tb-fname"
                                           placeholder="" value="{{ $proposal->name_alt }}">
                                </div>
                                <div class="col-2">
                                    <label for="tb-fname" class="text-end control-label col-form-label">Дата КП <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-2">
                                    <label for="tb-fname" class="text-end control-label col-form-label">Менеджер <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-1 pe-0">
                                    <label for="tb-fname" class="text-end control-label col-form-label">
                            ...
                            <div class="mb-5 row">
                                ...
                                @if($proposal->isForeignCurrency)
                                    <div class="col-2">
                                        <label for="tb-fname"
                                               class="col-sm-4 control-label col-form-label">Валюта</label>
                                ...
                                <div class="col-3">
                                    <label for="tb-fname" class="col-sm-4 control-label col-form-label">Язык</label>
                                    <div class="d-flex">
                            ...
                            <div class="row">
                                <div class="col-md-12 position-relative">
                                    ...
                                    <div class=" m-t-40 table-responsive" style="clear: both">
                                        <table border="1" class="table table-hover border-light-secondary"
                                               id="table_data"
                                                    ...
                                                    <td column="{{ $i }}"
                                                        ...
                                                        <div class="d-flex justify-content-center">
                                                            <input type="radio" class="btn-check" id="btn-main-{{ $i }}"
                                                                   ...
                                                                   value="{{ $i }}">
                                                            <label
                                                                @class(["btn rounded-pill font-weight-medium py-1 px-3 fs-2 m-0", " btn-outline-light-secondary" => $i > 1, "btn-outline-primary" => $i== 1]) for="btn-main-{{ $i }}">Основной</label>
                                                        </div>
                                                    </td>
                                                @endfor
                                            </tr>
                                    ...
                                    <div class="text-end">
                                        <div>
                                            <button type="button" id="submit"
                                                    class=" btn btn-info font-weight-medium rounded-pill px-4 disabled"
