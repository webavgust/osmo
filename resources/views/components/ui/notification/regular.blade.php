<div {{ $attributes->class(['fade', 'show', 'remove-close-icon', 'alert', 'customize-alert', 'alert-dismissible', 'border', 'border-'.$attributes['type'], 'text-'.$attributes['type'], 'font-weight-medium']) }}>
     @if(!empty($close))
