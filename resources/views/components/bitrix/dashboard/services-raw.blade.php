<div class="card">
    <div class="card-header d-flex justify-content-between px-3 align-items-center">
        <h4 class="card-title mb-0">Услуги без разработки</h4>
    </div>
    <div class="card-body p-0 text-center text-dark fw-bolder py-4" style="font-size: 40px;">
        <x-ui.a.box href="{{ route('dashboard.box.table', ['mode' => 'services_raw']) }}" class="p-0 ms-3 text-dark" style="margin-top: 4px; font-size: 40px;">
