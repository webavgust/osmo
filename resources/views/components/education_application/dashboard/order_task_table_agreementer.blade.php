    ...
    <div class="table-responsive">
        <table class="table stylish-table v-middle mb-0 no-wrap">
            ...
            <tr>
                ...
                <th class="border-0 text-muted fw-normal">Менеджер портал</th>
                <th class="border-0 text-muted fw-normal">Создан, кем</th>
                <th class="border-0 text-muted fw-normal">Создан, когда</th>
            </tr>
            </thead>
            <tbody>
            @forelse($data as $task)
                <x-dashboard.education_application_agree.tr_row_agreementer
                    :task="$task"></x-dashboard.education_application_agree.tr_row_agreementer>
            @empty
                <td colspan="4">
