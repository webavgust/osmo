<div class="table-responsive mt-2">
    ...
    @php
        $href = route("visit.box_to_working", $visit);
    @endphp
    <x-ui.a.box href="{{ $href }}" btn_type="warning">
        <x-ui.icon.solid icon="fa-calendar-days" class="me-1"></x-ui.icon.solid>
        <span>Открыть для заполнения</span>
    </x-ui.a.box>
</div>
