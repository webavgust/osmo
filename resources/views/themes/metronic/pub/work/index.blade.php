...
@section('styles')
    ...
    <style>
        /* панель bootstrap-table не нужна: «Добавить» — в тулбаре страницы, поиск — в шапке карточки */
...
@section('breadcrumb_right')
    ...
    <div id="filter" class="d-flex align-items-center gap-2">
        <button class="btn btn-light-info d-none" data-bs-toggle="modal" data-bs-target="#filter-modal">
