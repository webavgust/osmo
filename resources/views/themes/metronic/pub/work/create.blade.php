                ...
                <div class="card">
                    ...
                    <form id="form_create">
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                <label for="tb-fname"
                                       class="col-sm-4 col-form-label fw-semibold text-lg-end">Группа</label>
                                <div class="col-sm-4">
                                    <input  name="group" type="text" class="form-control " id="tb-fname"
                                           placeholder="" value="{{ old('group') }}">
                                </div>
                            </div>

                            <div class="mb-3 row">
                                <label for="tb-fname"
                                       class="col-sm-4 col-form-label fw-semibold text-lg-end">Язык</label>
                                <div class="col-sm-4">
                                    <div class="d-flex">
...
@section('js')
    ...
    <script>
        ...
        function sbm() {
            ...
            $.ajax({
                url: "{{ route('api.work.store', ['_token' => _token() ]) }}",
                type: "PUT",
                dataType: "json",
