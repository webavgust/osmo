                ...
                <div class="card">
                    ...
                    <form id="form_create">
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                <label for="tb-fname"
                                       class="col-sm-4 col-form-label fw-semibold text-lg-end">Расширение содержание</label>
                                <div class="col-sm-8">
                            ...
                            <div class="mb-3 row">
                                <label for="tb-fname"
                                       class="col-sm-4 col-form-label fw-semibold text-lg-end">Примечание</label>
                                <div class="col-sm-8">
                            ...
                            <div class="mb-3 row">
                                <label for="tb-fname"
                                       class="col-sm-4 col-form-label fw-semibold text-lg-end">Длительность (ч.)</label>
                                <div class="col-sm-1">
                            ...
                            <div class="mb-3 row">
                                <label for="tb-fname"
                                       class="col-sm-4 col-form-label fw-semibold text-lg-end">Стоимость</label>
                                <div class="col-sm-1">
                            ...
                            <div class="mb-3 row">
                                <label for="tb-fname"
                                       class="col-sm-4 col-form-label fw-semibold text-lg-end">НДС включено</label>
                                <div class="col-sm-1">
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" value="1" name="cb_nds" @checked($row->cb_nds ?? false)>
                                    </div>
                                </div>
                            </div>
...
@section('js')
    ...
    <script>
        ...
        function sbm() {
            ...
            $.ajax({
                url: "{{ route('api.software.update', [$row, '_token' => _token() ]) }}",
                type: "POST",
                dataType: "json",
