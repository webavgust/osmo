        ...
        <div class="card-body p-0">
            <div class="d-flex flex-column flex-lg-row">
                ...
                <div class="flex-column w-100 w-lg-325px border-end border-gray-200 flex-shrink-0">
                    ...
                    <ul class="list-group list-group-flush p-3 fs-5" id="neuroservice_groups">
                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle mb-0" id="table_neuroservices">
                            ...
                            @foreach($groups as $group)
                                @foreach($group->neuroservices()->get() as $neuroservice)
                                    <tr group="{{ $group->id }}" id="{{ $neuroservice->id }}" class="d-none fs-5">
                                        <td class="ps-4 pe-0">
                                        ...
                                        <td>
                                            <div class="d-flex flex-wrap gap-2">
                                                <span class="badge badge-light-info d-flex align-items-center gap-2 py-2 fs-7">
                                                ...
                                                <span class="badge badge-light-primary d-flex align-items-center gap-2 py-2 fs-7">
