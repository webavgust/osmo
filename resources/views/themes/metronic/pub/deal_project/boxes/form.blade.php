    ...
    @else
        ...
        <form id="deal_project_form" onsubmit="return false;">
            ...
            <div id="deal_project_fields">
                ...
                {{-- «Срок» показывается, только когда стоит «Пилот»: срок есть у пилота,
                     обычный проект живёт без планового окончания (правка владельца 11.09.2026) --}}
                <div class="row g-4 mb-4 @unless($project?->is_pilot) d-none @endunless" id="deal_project_deadline_row">
                    <div class="col-lg-4">
        ...
        <script>
            (function () {
                ...
                /** Показать «Срок» только когда стоит «Пилот» */
