...
@section('content')
    ...
    <div style="width: 297mm; margin: 0 auto; padding: 10mm; box-sizing: border-box;" id="print" contentEditable="true">
        <div class="text-center">
            <h1 class="mb-9" style="font-size: 2.5rem">{{ __('proposal_pdf.title') }}</h1>
        </div>
                ...
                @foreach($variants as $variant)
                   ...
                   <tr class="subcaption">
                        <th width="150" class="text-center py-1">
                            <div class="fs-6">{{ __('proposal_pdf.proposal_amount') }} @if($has_customer_discount) ** @endif</div>
...
//                            }
        ...
        @foreach($variants as $variant)
            ...
            <table id="table-summary" class="table no-wrap w-100" keep="main_table">
                ...
                <tr>
                    <td colspan="4" class="text-end fw-bold fs-4">
