                            ...
                            <div class="row">
                                ...
                                <div class="col-1 pe-0">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <input required name="number" type="text" class="form-control  w-100 "
                                        ...
                                        <a href="javascript:void(0)"
                                           ...
                                           class="ms-2 fw-bold fs-7 text-nowrap">
                                            {{ $max_number }}
                                        </a>
                                    </div>
                                </div>
                                <div class="col-1 pe-0">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <input required name="nds" type="text" class="form-control " id="tb-fname" value="{{ $proposal->nds }}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <select name="period[{{ $i }}]"
                                                                            class="form-select period p-1 fs-6 flex-grow-1"
                                                                    ...
                                                                    <input name="period_value[{{ $i }}]" maxlength="2"
                                                                           type="text"
                                                                           class="form-control p-1 fs-5 flex-grow-0 text-center count"
                                                                           style="width: 30px"
                                                    ...
                                                    <td column="{{ $i }}"
                                                        ...
                                                        <div class="d-flex justify-content-center">
                                                            <input type="radio" class="btn-check" id="btn-main-{{ $i }}"
                                                                   ...
                                                                   value="{{ $i }}">
                                                            <label
                                                                @class(["btn rounded-pill font-weight-medium py-1 px-3 fs-5 m-0", "btn-light-info" => $i > 1, "btn-info" => $i== 1]) for="btn-main-{{ $i }}">Основной</label>
                                                        </div>
                                                    </td>
                                                @endfor
                                            </tr>
                                                            ...
                                                            <div class="cell">
                                                                <div class="form-check d-flex justify-content-between">
                                                                    <input
                                                                        ...
                                                                        class="active form-check-input mt-7 me-1"
                                                                    ...
                                                                    <div class="cell-active flex-grow-1">
                                                                        <div
                                                                            ...
                                                                            <span
                                                                                class="text-nowrap fs-6">Скидка (%)</span>
                                                                        </div>
                                                                        <div class="input-group">
                                                                            <input
                                                                                ...
                                                                                value="<?=$cell->count ?? 1 ?>"
                                                                                class="count form-control p-1 fs-6 text-end"
                                                                                aria-label="Text input with checkbox">
                                                                            <input
                                                                                name="platform_cell[{{ $i }}][{{ $j }}][discount]"
                                                                                type="number" min="0" max="99"
                                                                                value="<?=$cell->discount ?? 0 ?>"
                                                                                class="discount form-control p-1 fs-6 text-end"
                                                                                aria-label="Text input with checkbox">
                                                                        </div>

                                                                        <div
                                                                            class="text-start mt-1 fs-6 text-secondary">
                                                                            <input type="hidden"
                                                                                   name="platform_cost[{{ $i }}][{{ $j }}]"
                                                                                   value="{{ $cost }}"
                                                                                   class="fs-6 p-0 inp_cost_cell">
                                                                            <a class="cost_cell"
                                                                        ...
                                                                        <div class="fs-2 d-flex align-items-center mt-2 justify-content-start d-none">
                                                                            ...
                                                                            >
                                                                            <label class="form-check-label fs-6 fw-normal m-0 ms-1" for="platform_nds_{{ $i }}_{{ $j }}">НДС</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <th style="min-width: 35vw" class="p-1 px-2 border-bottom" colspan="3">
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <a class="fast_soft_add d-flex align-items-center"
                                                           href="javascript:void(0);" onclick="javascript:soft_add();" class="fw-bold fs-6">
                                                                            ...
                                                                            <div class="flex-grow-1">
                                                                                ...
                                                                                <div class="input-group">
                                                                                    <input
                                                                                        ...
                                                                                        max="999999"
                                                                                        value="{{ $cell->cost ?? 0 }}"
                                                                                        class="cost form-control p-0 py-1 fs-6 text-end"
                                                                                        style="width: 30px;">
                                                                                    <input
                                                                                        name="soft_cell[{{ $i }}][{{ $j }}][count]"
                                                                                        type="number" min="0" max="9999"
                                                                                        value="{{ $cell->count ?? 0 }}"
                                                                                        class="count form-control p-0 py-1 fs-6 text-end"
                                                                                        style="width: 25px;">
                                                                                    <input
                                                                                        name="soft_cell[{{ $i }}][{{ $j }}][discount]"
                                                                                        type="number" min="0" max="99"
                                                                                        value="{{ $cell->discount_customer ?? 0 }}"
                                                                                        class="discount form-control p-0 py-1 fs-6 text-end">
                                                                                </div>
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <label
                                                                                        class="form-check-label fs-6 fw-normal m-0 ms-1"
                                                                                ...
                                                                                <div class="text-end">
                                                                                    <span
                                                                                        class="text-start fs-6 text-secondary">
                                                                                       <span
                                                ...
                                                <th style="min-width: 35vw" class="p-1 px-2 border-bottom sort_star"
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div class="d-flex justify-content-center align-items-center">
                                                            ...
                                                            <a class="fast_scenario_add d-flex align-items-center fw-bold fs-6"
                                                               href="javascript:void(0);"
                                            ...
                                            <tr class="work_header bg-light-warning">
                                                <th style="min-width: 35vw" class="p-1 px-2 border-bottom" colspan="3">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <a class="fast_work_add d-flex align-items-center fw-bold fs-6"
                                                                        ...
                                                                        <div class="cell-active flex-grow-1">
                                                                            ...
                                                                            <div class="input-group">
                                                                                <input
                                                                                    ...
                                                                                    type="number" min="1" max="999999"
                                                                                    value="{{ $cell->cost ?? 0 }}"
                                                                                    class="cost form-control p-1 fs-6 text-end"
                                                                            ...
                                                                            <div class="d-flex align-items-center justify-content-start">
                                                                                <input
                                                                                    ...
                                                                                    class="discount_partner form-control p-1 fs-6 text-end">
                                                    ...
                                                    <td column="{{ $i }}" @class(["border-start border-bottom flex-grow-0  py-2", "d-none" => $i > $proposal_variants->count(), "column_hl" => $i == 1])  style="width: 140px!important">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <input
                                                                ...
                                                                name="partner_platform_discount[{{ $i }}]" type="number" min="0" max="99" class="partner form-control p-1 fs-6 text-end" style="width: 42px">

                                                            <div class="text-end flex-grow-1 text-nowrap ms-2">
                                                                <span class="column_subtotal fs-6">0</span> {{ $cur_symbol }}
                                                            </div>
                                                        </div>
                                                    </td>
                                                @endfor
                                                    ...
                                                    <td column="{{ $i }}" @class(["border-start border-bottom flex-grow-0  py-2", "d-none" => $i > $proposal_variants->count(), "column_hl" => $i == 1])  style="width: 140px!important">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <input
                                                                ...
                                                                name="partner_neuro_discount[{{ $i }}]" type="number" min="0" max="99" class="partner form-control p-1 fs-6 text-end" style="width: 42px">
                                            ...
                                            <tr class="platform_total">
                                                ...
                                                @for($i = 1; $i <= $columns; $i++)
                                                    <td column="{{ $i }}"
                                                        ...
                                                        <div class="fs-7 text-end nds text-info d-none">НДС: <span class="amount">0</span> {{ $cur_symbol }}</div>
                                                    </td>
                                                @endfor
                                            </tr>
                                            ...
                                            <tr class="soft_total">
                                                ...
                                                @for($i = 1; $i <= $columns; $i++)
                                                    <td column="{{ $i }}"
                                                        ...
                                                        <div class="fs-7 text-end nds text-warning d-none">НДС: <span
                                            ...
                                            <div>
                                                <div class="form-check form-check-inline mt-2">
                                                    <input
                                                        ...
                                                        name="new_iteration">
                                                    <label class="form-check-label fw-normal fs-6 text-danger"
